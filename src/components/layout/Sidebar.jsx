  ...
  return (
    <aside className="w-60 bg-white border-r border-gray-200 flex flex-col h-screen sticky top-0">
      ...
      <nav className="flex-1 px-3 py-4 overflow-y-auto">
        {/* CHAT section */}
        <p className="px-3 mb-2 text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Chat</p>
        <button
        ...
        {/* COMING SOON section */}
        <p className="px-3 mt-5 mb-2 text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Coming Soon</p>
        {comingSoonItems.map((item) => (
          <div
            key={item.label}
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-300 cursor-default"
          >
        ...
        {/* TOOLS section */}
        <p className="px-3 mt-5 mb-2 text-[10px] font-semibold text-gray-400 uppercase tracking-widest">Tools</p>
        {externalLinks.map((link) => (
          ...
          >
            ...
            {link.placeholder && <span className="text-[9px] text-gray-300 uppercase">TBD</span>}
          </a>
        ))}
      </nav>

      <div className="px-4 py-4 border-t border-gray-100 text-xs text-gray-400">
        Luca v0.3 &middot; Breeze
      </div>
    </aside>
  );
}
