    ...
    <aside className="w-60 bg-white border-r border-gray-200 flex flex-col h-screen sticky top-0">
      <div className="px-5 py-5 border-b border-gray-100">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-semibold text-deep-navy">Breeze</span>
        </div>
      </div>
          ...
          if (isComingSoon) {
            return (
              ...
              >
                ...
                {tab.label}
                <span className="ml-auto text-[10px] font-medium text-gray-300 uppercase tracking-wider">Soon</span>
              </div>
            );
          }
